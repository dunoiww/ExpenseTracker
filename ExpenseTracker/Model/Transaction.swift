...
extension Category {
    static let autoAndTransport = Category(id: 1, name: "Phương tiện", icon: .car_alt, type: "Expense")
    static let billsAndUtilities = Category(id: 2, name: "Hoá đơn", icon: .file_invoice_dollar, type: "Expense")
    static let entertainment = Category(id: 3, name: "Giải trí", icon: .film, type: "Expense")
    static let feesAndCharges = Category(id: 4, name: "Phí", icon: .hand_holding_usd, type: "Expense")
    static let foodAndDining = Category(id: 5, name: "Thực phẩm", icon: .hamburger, type: "Expense")
    static let home = Category(id: 6, name: "Nhà", icon: .home, type: "Expense")
    static let income = Category(id: 7, name: "Thu nhập", icon: .dollar_sign, type: "Expense")
    static let shopping = Category(id: 8, name: "Mua bán", icon: .shopping_cart, type: "Expense")
    static let transfer = Category(id: 9, name: "Trao đổi", icon: .exchange_alt, type: "Expense")
    
    static let salary = Category(id: 10, name: "Lương", icon: .dollar_sign, type: "Income")
    static let allowance = Category(id: 11, name: "Phụ cấp", icon: .piggy_bank, type: "Income")
    static let bonus = Category(id: 12, name: "Thưởng", icon: .gift, type: "Income")
    static let invest = Category(id: 13, name: "Đầu tư", icon: .coins, type: "Income")
    static let wage = Category(id: 14, name: "Kiếm thêm", icon: .funnel_dollar, type: "Income")
